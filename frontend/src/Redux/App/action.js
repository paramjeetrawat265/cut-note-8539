...
const addProducts = (payload, headers) => (dispatch) => {
  ...
  return axios
    .post(`${REACT_APP_API_URL}dashboard/product/add`, payload, headers)
    .then((res) => {
...
const productData = (payload) => (dispatch) => {
  ...
  return axios
    .get(`${REACT_APP_API_URL}dashboard/products`, payload)
    .then((res) => {
...
const productDelete = (payload, headers) => (dispatch) => {
  ...
  return axios
    .delete(
      `${REACT_APP_API_URL}dashboard/product/delete/${payload.id}`,
      headers
    )
    .then((res) => {
...
const getProducts = () => (dispatch) => {
  ...
  return axios
    .get(`${REACT_APP_API_URL}data/products`)
    .then((res) => {
