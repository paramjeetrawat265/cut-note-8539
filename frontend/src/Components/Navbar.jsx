...
const Navbar = () => {
  ...
  const list = (anchor) => (
    ...
    >
      <Button size="large" href="https://www.google.com" sx={{ml: 10}}>
        SignIN
      </Button>
      <List>
        {[
  ...
  const news = (
    <MenuContainer>
      <List sx={{mt: 5, width: "250px"}}>
        <Divider />
        <Typography textAlign="center" sx={{size: "large"}} padding="10px">
          {menu}
        </Typography>
        <Divider />
        <Typography textAlign="Center" sx={{mt: 2, fontWeight: 700}}>
          Shop New Arrivals
        </Typography>
        {[
          {title: "For Women", path: "/women"},
        ...
        <Typography sx={{mt: 2, ml: 2, mb: 0, color: "gray", fontWeight: 700}}>
          Women
        </Typography>
        {[
    ...
    <MenuContainer>
      <List sx={{mt: 5, width: "250px"}}>
        ...
        >
          ...
          {!plus && (
            <HiPlus
              style={{position: "absolute", top: 17, left: 180}}
        ...
        <Box sx={{flexGrow: 1, ml: 2, mr: 2, mt: 2}}>
          <Grid container spacing={{xs: 1}} columns={{xs: 20, sm: 12, md: 12}}>
            {plus &&
              ["XXS", "XS", "S", "M", "L", "XXL", "XL", "2X", "3X", "L"].map(
                (ele, index) => (
          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{flexGrow: 1, display: {xs: "flex", md: "none"}}}>
              ...
              >
                {/* hover menus  */}
                {pages.map((page) => (
                  <MenuItem key={page} onClick={toggleDrawer("left", false)}>
            ...
            <Box sx={{flexGrow: 1, display: {xs: "none", md: "flex"}}}>
              {pages.map((page) => (
                <>
                  ...
                  >
                    <Typography onMouseOver={(event) => handleClick(event)}>
                      {page}
                    </Typography>
                  </Button>
                  {hoverMenu !== "" && (
                    ...
                    >
                      {hoverMenu === "GIFTS" && (
                        <Box sx={{padding: 1, width: "200px"}}>
                          <MenuItem onClick={handleClose}>
                            <Typography
                              sx={{fontWeight: 800, color: "gray", mb: 1}}
                            >
                              GIFTS
                            </Typography>
                          </MenuItem>
                          ...
                          <MenuItem onClick={handleClose}>
                            <Link to="/girl">For Girls</Link>
                          </MenuItem>
                          <MenuItem onClick={handleClose}>
                            <Link to="/boy">For Boys</Link>
                          </MenuItem>
                          <MenuItem onClick={handleClose}>
                            <Link to="/home">For Home</Link>
                          </MenuItem>
                        </Box>
                      )}
                      {hoverMenu === "NEW" && (
                        <Box sx={{display: "flex"}}>
                          <Box sx={{padding: 1}}>
                            <MenuItem onClick={handleClose}>
                              <Typography
                                sx={{fontWeight: 700, color: "#343434", mb: 1}}
                              >
                                Shop New Arrivals
                              </Typography>
                            </MenuItem>
                          ...
                          <Box sx={{padding: 1}}>
                            <MenuItem onClick={handleClose}>
                              <Typography
                                sx={{fontWeight: 700, color: "#343434", mb: 0}}
                              >
                                What To Shop Now
                              </Typography>
                            </MenuItem>
                          ...
                          <Box sx={{padding: 1, paddingRight: 3}}>
                            ...
                            <Box sx={{display: "flex", gap: 0}}>
                              <div width="180px" padding="5px">
                                <img
                                  src="https://www.jcrew.com/brand_creative/2022/202212-Dec/flyout/2022dec_1108_flyouts_new_img0.jpg"
                                  height="200px"
                                  width="100%"
                                ></img>
                                <p>
                                  The Holiday <br></br>Party Shop
                                </p>
                              </div>
                              <div width="180px" padding="5px">
                                <img
                                  src="https://www.jcrew.com/brand_creative/2022/202212-Dec/flyout/2022dec_1108_flyouts_new_img1.jpg"
                                  height="200px"
                                  width="100%"
                                ></img>
                                <p>The Sun Shop</p>
                      ...
                      {hoverMenu === "WOMEN" && (
                        <Box
                          sx={{display: "flex", width: "80vw", margin: "auto"}}
                        >
                          <Box>
                            <Box sx={{padding: 1}}>
                              <MenuItem onClick={handleClose}>
                              ...
                              <MenuItem
                                onClick={handleClose}
                                sx={{fontWeight: 550, color: "#36454F"}}
                              >
                                New Arrivals
                              </MenuItem>
                              <MenuItem
                          ...
                          <Box sx={{padding: 1}}>
                            <MenuItem onClick={handleClose}>
                              <Typography
                                sx={{fontWeight: 600, color: "#343434", mb: 1}}
                              >
                                Clothing
                              </Typography>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/alldata">All Clothing</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Sweaters</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Shirts & Tops</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">T-shirts & Tank</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Dresses & Jumpsuits</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Blazzers</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Pants</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Denims</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Coats & Jackets</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Skirts</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Shorts</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Swimwear</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Active</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/women">Matching Sets</Link>
                            </MenuItem>
                          </Box>
                          ...
                          <Box sx={{padding: 1, paddingRight: 3}}>
                            ...
                            <Box sx={{display: "flex", gap: 3}}>
                              <div width="180px" padding="5px">
                                <img
                                  src="https://www.jcrew.com/brand_creative/2022/202212-Dec/flyout/2022dec_1108_flyouts_w_img0.jpg"
                                  height="200px"
                                  width="100%"
                                ></img>
                                <p>New Arrival</p>
                              ...
                              <div width="180px" padding="5px">
                                <img
                                  src="https://www.jcrew.com/brand_creative/2022/202212-Dec/flyout/2022dec_1108_flyouts_w_img1.jpg"
                                  height="200px"
                                  width="100%"
                                ></img>
                                <p>Holiday Party</p>
                            ...
                            <Box sx={{display: "flex", gap: 3, mt: 3}}>
                              <div width="100px">
                                <img
                                  src="https://www.jcrew.com/brand_creative/2022/202212-Dec/flyout/2022dec_1108_flyouts_w_img4.jpg"
                                  height="130px"
                                  width="100px"
                                ></img>
                                <p>New Arrival</p>
                              ...
                              <div width="100px">
                                <img
                                  src="https://www.jcrew.com/brand_creative/2022/202212-Dec/flyout/2022dec_1108_flyouts_w_img3.jpg"
                                  height="130px"
                                  width="100px"
                                ></img>
                                <p>Holiday Party</p>
                              ...
                              <div width="100px">
                                <img
                                  src="https://www.jcrew.com/brand_creative/2022/202212-Dec/flyout/2022dec_1108_flyouts_w_img2.jpg"
                                  height="130px"
                                  width="100px"
                                ></img>
                                <p>Holiday Party</p>
                      ...
                      {hoverMenu === "MEN" && (
                        ...
                        >
                          ...
                          <Box sx={{padding: 1}}>
                            ...
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Sweaters</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Shirts & Tops</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">T-shirts & Tank</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Dresses & Jumpsuits</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Blazzers</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Pants</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Denims</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Coats & Jackets</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Skirts</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                            ...
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Active</Link>
                            </MenuItem>
                            <MenuItem onClick={handleClose}>
                              <Link to="/men">Matching Sets</Link>
                            </MenuItem>
                          </Box>
            ...
            <Box
              sx={{display: {xs: "none", lg: "flex", md: "flex"}, mr: 2}}
              component="div"
            ...
            >
              <Tooltip>
                <IconButton onClick={handleOpenUserMenu} sx={{p: 0}}>
                  {isAuth ? (
                    <>
                      <p onClick={handleSignout} className="signIn">
                        SignOut
                      </p>
                    </>
                  ) : (
                    <>
                      <p onClick={handleModalOpen} className="signIn">
                        SignIn
                      </p>
                      <div>
                        {!isAuth && (
                          <>
                            ...
                            >
                              {authComponent === "Login" && !isAuth ? (
                                <Login setauthComponent={setauthComponent} />
                              ) : (
            ...
            <Box
              sx={{display: {sm: "flex", lg: "flex", md: "flex"}, mr: 1}}
              marginLeft="20px"
              display="flex"
              alignItems="center"
              height="30px"
